...
if __name__ == '__main__':
    ...
    # parser.add_argument('--brgb_root', type=str, default='results/aligned/TFM/test_pairs/tryon',help='path to the painted back rgb image')
    parser.add_argument('--parse_root', type=str, default='example/image-parse',help='')

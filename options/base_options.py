...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default='mpv3d_example',help='path to dataset')
        parser.add_argument('--datamode', type=str, default='aligned',help='dataset mode for MTM [unaligned | aligned]')
        parser.add_argument('--datalist', type=str, default='test_pairs', help='mpv3d data list [train_pairs | test_pairs | test_score]')
        ...
        parser.add_argument('--gpu_ids', type=str, default='-1', help='gpu ids: e.g. 0,1,2, currently we only support single GPU, use -1 for CPU')
    ...
    def parse(self):
        ...
        # If no GPUs are specified or CUDA is not available, use CPU
